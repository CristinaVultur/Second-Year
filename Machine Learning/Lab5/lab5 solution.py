...
def get_accuracy_statistics(train_data, train_labels, test_data, test_labels, Cs, normalization_type=None):
    ...
    for c_idx, c in enumerate(Cs):
        ...
        training_accuracies[c_idx] = compute_accuracy(train_labels,
                                                      linear_svm_model.predict(scaled_training_data)) * 100
...
std_accuracies_train, std_accuracies_test = get_accuracy_statistics(train_images, train_labels, test_images,
                                                                    test_labels, Cs, 'standard')
...
l2_accuracies_train, l2_accuracies_test = get_accuracy_statistics(train_images, train_labels, test_images, test_labels,
                                                                  Cs, 'l2')
